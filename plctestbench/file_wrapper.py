...
class FileWrapper(object):
    ...
    @classmethod
    def from_path(cls, path: str) -> FileWrapper | None:
...
class AudioFile(FileWrapper):
    ...
    def get_samplerate(self) -> float | None:
    ...
    def get_endian(self) -> str | None:
        return self.endian

    def get_audio_format(self) -> str | None:
