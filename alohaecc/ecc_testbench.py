...
class ecc_testbench(object):
    ...
    def __init__(self,
        ...
        '''
            ...
            Input:
                ecc_algorithm: The chosen method of error concealment of the input signal after packet loss is applied
                buffer_size: Default buffer size. Can be overriden if necessary.
    ...
    def run(self, wave_files):
        ...
        '''
            ...
            Output:
                mse: Mean Square Error calculated for all input audio files and their corrected copies when packet loss simulation and error correction has been applied
        '''
        ...
        for wave in self.wave_files:
            ...
            # TODO:conditional array shape checking to remove wavs in fileset with >= n channels before processing
            
            print("Processing Audio ... %s \n" % wave)
        

            lost_packet_mask = self.packet_drop_simulator.generate_lost_packet_mask(len(input_waves))
